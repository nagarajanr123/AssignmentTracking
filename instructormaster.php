...
<div class="container theme-showcase" role="main">
	...
	<div class="panel-heading contains-buttons">
	    <h3 class="panel-title">Instructor Master </h3>
		<div class="btn-group pull-right">
		<a href="instructoradd.php" class="btn btn-default btn-sm" >Add New Instructor</a>
...
foreach ($ilist as $value) { $count++; ?>
		...
		<td><a href="instructoradd.php?id=<?php echo $value[4]; ?>" class="btn btn-info ">Modify</a></td>
            </tr>
        </tbody>
<?php
}
